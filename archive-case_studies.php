...
li.orbit-slide {
	...
	<div id="content">
		...
		<div id="inner-content" class="row expanded">
			...
			<h2>Case Studies</h2>
			<div class="divider-links"><span class="hide-for-small-only">All Case Studies</span></div>
			</div>

			<?php $case_studies = get_case_studies_data(); ?>
			    						...
			    						<h3 class="concord-services-title-box">What We Did:</h3>
					      				<ul class="two-col-list">
						      				<?php foreach ($case['services'] as $concord_service): ?>
						      					<li><?php echo $concord_service->post_title; ?></li>
						      				<?php endforeach; ?>
					      				</ul>
								</div>
					      		...
					      		<div class="quote-overlay">
					      			<div>
					      				...
					      				<?php if ($link = $case['quote_link']) : ?>
					      					<a class="quote-link" href="<?php echo $link; ?>"></a>
					      				<?php endif; ?>
					      			</div>
					      		</div>
					      	</div>
					      <?php endif; ?>
							  ...
							  <div class="medium-4 large-4 columns" data-equalizer-watch>
							    <div class="image-wrapper overlay-fade-in">
							    	<img class="img-responsive" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/08/service-property-management.jpg" />
							    	<div class="image-overlay-content"></div>
							    </div>
							  </div>
							  <div class="medium-4 large-4 columns">
							    <div class="image-wrapper overlay-fade-in">
							    	<img class="img-responsive" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/08/services-capital-markets.jpg" />
							    	<div class="image-overlay-content"></div>
							    </div>
							  </div>
							  <div class="medium-4 large-4 columns">
							    <div class="image-wrapper overlay-fade-in">
							    	<img class="img-responsive" src="<?php echo get_site_url(); ?>/wp-content/uploads/2016/08/services-advisory.jpg" />
							      	<div class="image-overlay-content"></div>
							    </div>
							  </div>
